import{j as r,b as P}from"./index-BPnQxTxN.js";import{useMDXComponents as h}from"./index-jHNXCE98.js";import"./iframe-C84a9qSP.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-C__6K5js.js";import"./index-Bhqu_tAV.js";const S=`:root,
:host {
  /* Primitive layer */
...
`)){const c=e.trim();if(c.startsWith("/*")){c.includes("Primitive layer")?a="primitive":c.includes("Semantic layer")?a="semantic":c.includes("Component layer")&&(a="component");continue}const s=e.match(x);if(!s||!a)continue;const[,N,T]=s;n[a].push({name:N,value:k(T)})}return n}function j(o){const n=new Map;for(const a of o.split(`
`)){const e=a.match(x);if(!e)continue;const[,c,s]=e;n.set(c,k(s))}return n}function t(o,n){return o.name.localeCompare(n.name,void 0,{numeric:!0})}function l(o,n){return o.filter(a=>a.name.startsWith(n))}function R(o,n){return o.filter(a=>n.some(e=>a.name.startsWith(e)))}const w=V(S),y=j(M),z=j(C),i=[...w.primitive],d=l(i,"--rowan-color-").sort(t),m=l(i,"--rowan-space-").sort(t),b=l(i,"--rowan-radius-").sort(t),g=R(i,["--rowan-font-","--rowan-line-height"]).sort(t),v=l(i,"--rowan-border-").sort(t),p=[...w.semantic].sort(t),f=[...w.component].sort(t),A=[...new Set([...y.keys(),...z.keys()])].sort((o,n)=>o.localeCompare(n,void 0,{numeric:!0})),D=A.map(o=>({name:o,light:y.get(o)||"-",dark:z.get(o)||"-"})),L=["src/tokens/tokens.css","src/tokens/themes/light.css","src/tokens/themes/dark.css"];function u(o){const n={h1:"h1",h2:"h2",p:"p",span:"span",td:"td",tr:"tr",...h(),...o.components};return r.jsxs(r.Fragment,{children:[r.jsx(P,{title:"Foundations/Tokens"}),`
...
`,r.jsx("div",{className:"tokens-table-wrap",children:r.jsxs("table",{className:"tokens-table",children:[r.jsx("thead",{children:r.jsxs("tr",{children:[r.jsx("th",{children:"Token"}),r.jsx("th",{children:"Value"}),r.jsx("th",{children:"Preview"})]})}),r.jsx("tbody",{children:[...g,...v].map(a=>r.jsxs(n.tr,{children:[r.jsx(n.td,{className:"tokens-name",children:a.name}),r.jsx(n.td,{className:"tokens-value",children:a.value}),r.jsx(n.td,{children:r.jsx(n.span,{className:"tokens-preview",children:r.jsx(n.span,{className:"tokens-preview-font",children:"Ag"})})})]},a.name))})]})}),`
