import{j as r,b as P}from"./index-CCWjqpfY.js";import{useMDXComponents as h}from"./index-q7G_RCzh.js";import"./iframe-CncKs1vE.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-C__6K5js.js";import"./index-Bhqu_tAV.js";const S=`:root,
:host {
  /* Primitive layer */
...
`,C=`[data-theme="dark"] {
  ...
  /* Re-declared so a nested [data-theme] scope re-resolves these against this theme. */
  --rowan-button-fg: var(--rowan-color-accent-contrast);
  --rowan-field-bg: var(--rowan-color-surface);
  --rowan-field-fg: var(--rowan-color-fg);
  --rowan-field-border: var(--rowan-color-border);
...
`,x=/^\s*(--rowan-[\w-]+)\s*:\s*([^;]+);/;function k(a){return a.trim().replace(/\s+/g," ")}function M(a){const n={primitive:[],semantic:[],component:[]};let o=null;for(const e of a.split(`
`)){const c=e.trim();if(c.startsWith("/*")){c.includes("Primitive layer")?o="primitive":c.includes("Semantic layer")?o="semantic":c.includes("Component layer")&&(o="component");continue}const i=e.match(x);if(!i||!o)continue;const[,N,T]=i;n[o].push({name:N,value:k(T)})}return n}function j(a){const n=new Map;for(const o of a.split(`
`)){const e=o.match(x);if(!e)continue;const[,c,i]=e;n.set(c,k(i))}return n}function t(a,n){return a.name.localeCompare(n.name,void 0,{numeric:!0})}function l(a,n){return a.filter(o=>o.name.startsWith(n))}function V(a,n){return a.filter(o=>n.some(e=>o.name.startsWith(e)))}const w=M(S),y=j(R),z=j(C),s=[...w.primitive],d=l(s,"--rowan-color-").sort(t),m=l(s,"--rowan-space-").sort(t),g=l(s,"--rowan-radius-").sort(t),b=V(s,["--rowan-font-","--rowan-line-height"]).sort(t),v=l(s,"--rowan-border-").sort(t),p=[...w.semantic].sort(t),u=[...w.component].sort(t),A=[...new Set([...y.keys(),...z.keys()])].sort((a,n)=>a.localeCompare(n,void 0,{numeric:!0})),D=A.map(a=>({name:a,light:y.get(a)||"-",dark:z.get(a)||"-"})),L=["src/tokens/tokens.css","src/tokens/themes/light.css","src/tokens/themes/dark.css"];function f(a){const n={h1:"h1",h2:"h2",p:"p",span:"span",td:"td",tr:"tr",...h(),...a.components};return r.jsxs(r.Fragment,{children:[r.jsx(P,{title:"Foundations/Tokens"}),`
...
and component tokens bind component defaults to semantic meaning.`})}),r.jsxs("div",{className:"tokens-layer-grid",children:[r.jsxs("article",{className:"tokens-layer-card",children:[r.jsx("h3",{children:"Primitive layer"}),r.jsx("p",{children:"Raw design values: palette ramps, spacing, radius, typography, and structural constants."}),r.jsx("span",{className:"tokens-layer-count",children:r.jsxs(n.p,{children:[d.length+m.length+g.length+b.length+v.length," ",`
tokens`]})})]}),r.jsxs("article",{className:"tokens-layer-card",children:[r.jsx("h3",{children:"Semantic layer"}),r.jsx("p",{children:"Theme-level meaning used by components: background, foreground, accent, border, danger."}),r.jsxs("span",{className:"tokens-layer-count",children:[p.length," tokens"]})]}),r.jsxs("article",{className:"tokens-layer-card",children:[r.jsx("h3",{children:"Component layer"}),r.jsx("p",{children:"Default component hooks that map to semantic values and support local overrides."}),r.jsxs("span",{className:"tokens-layer-count",children:[u.length," tokens"]})]})]}),r.jsxs("p",{className:"tokens-note",children:["Source of truth: ",L.join(", ")]}),r.jsx("p",{className:"tokens-theme-hint",children:r.jsx(n.p,{children:"Use the Storybook toolbar Theme toggle to inspect token behavior across light and dark modes."})})]}),`
`,r.jsx(n.h2,{id:"primitive-color",children:"Primitive: Color"}),`
`,r.jsx("div",{className:"tokens-table-wrap",children:r.jsxs("table",{className:"tokens-table",children:[r.jsx("thead",{children:r.jsxs("tr",{children:[r.jsx("th",{children:"Token"}),r.jsx("th",{children:"Value"}),r.jsx("th",{children:"Preview"})]})}),r.jsx("tbody",{children:d.map(o=>r.jsxs(n.tr,{children:[r.jsx(n.td,{className:"tokens-name",children:o.name}),r.jsx(n.td,{className:"tokens-value",children:o.value}),r.jsx(n.td,{children:r.jsx(n.span,{className:"tokens-preview",children:r.jsx(n.span,{className:"tokens-preview-color",style:{background:`var(${o.name})`}})})})]},o.name))})]})}),`
`,r.jsx(n.h2,{id:"primitive-space",children:"Primitive: Space"}),`
`,r.jsx("div",{className:"tokens-table-wrap",children:r.jsxs("table",{className:"tokens-table",children:[r.jsx("thead",{children:r.jsxs("tr",{children:[r.jsx("th",{children:"Token"}),r.jsx("th",{children:"Value"}),r.jsx("th",{children:"Preview"})]})}),r.jsx("tbody",{children:m.map(o=>r.jsxs(n.tr,{children:[r.jsx(n.td,{className:"tokens-name",children:o.name}),r.jsx(n.td,{className:"tokens-value",children:o.value}),r.jsx(n.td,{children:r.jsx(n.span,{className:"tokens-preview",children:r.jsx(n.span,{className:"tokens-preview-space",style:{width:`var(${o.name})`}})})})]},o.name))})]})}),`
`,r.jsx(n.h2,{id:"primitive-radius",children:"Primitive: Radius"}),`
`,r.jsx("div",{className:"tokens-table-wrap",children:r.jsxs("table",{className:"tokens-table",children:[r.jsx("thead",{children:r.jsxs("tr",{children:[r.jsx("th",{children:"Token"}),r.jsx("th",{children:"Value"}),r.jsx("th",{children:"Preview"})]})}),r.jsx("tbody",{children:g.map(o=>r.jsxs(n.tr,{children:[r.jsx(n.td,{className:"tokens-name",children:o.name}),r.jsx(n.td,{className:"tokens-value",children:o.value}),r.jsx(n.td,{children:r.jsx(n.span,{className:"tokens-preview",children:r.jsx(n.span,{className:"tokens-preview-radius",style:{borderRadius:`var(${o.name})`}})})})]},o.name))})]})}),`
`,r.jsx(n.h2,{id:"primitive-typography-and-structural",children:"Primitive: Typography and Structural"}),`
`,r.jsx("div",{className:"tokens-table-wrap",children:r.jsxs("table",{className:"tokens-table",children:[r.jsx("thead",{children:r.jsxs("tr",{children:[r.jsx("th",{children:"Token"}),r.jsx("th",{children:"Value"}),r.jsx("th",{children:"Preview"})]})}),r.jsx("tbody",{children:[...b,...v].map(o=>r.jsxs(n.tr,{children:[r.jsx(n.td,{className:"tokens-name",children:o.name}),r.jsx(n.td,{className:"tokens-value",children:o.value}),r.jsx(n.td,{children:r.jsx(n.span,{className:"tokens-preview",children:r.jsx(n.span,{className:"tokens-preview-font",children:"Ag"})})})]},o.name))})]})}),`
`,r.jsx(n.h2,{id:"semantic-tokens",children:"Semantic Tokens"}),`
`,r.jsx("div",{className:"tokens-table-wrap",children:r.jsxs("table",{className:"tokens-table",children:[r.jsx("thead",{children:r.jsxs("tr",{children:[r.jsx("th",{children:"Token"}),r.jsx("th",{children:"Value"}),r.jsx("th",{children:"Preview"})]})}),r.jsx("tbody",{children:p.map(o=>r.jsxs(n.tr,{children:[r.jsx(n.td,{className:"tokens-name",children:o.name}),r.jsx(n.td,{className:"tokens-value",children:o.value}),r.jsx(n.td,{children:r.jsx(n.span,{className:"tokens-preview",children:o.name.includes("color")?r.jsx(n.span,{className:"tokens-preview-color",style:{background:`var(${o.name})`}}):r.jsx(n.span,{className:"tokens-preview-font",children:"Ag"})})})]},o.name))})]})}),`
`,r.jsx(n.h2,{id:"component-tokens",children:"Component Tokens"}),`
`,r.jsx("div",{className:"tokens-table-wrap",children:r.jsxs("table",{className:"tokens-table",children:[r.jsx("thead",{children:r.jsxs("tr",{children:[r.jsx("th",{children:"Token"}),r.jsx("th",{children:"Value"}),r.jsx("th",{children:"Preview"})]})}),r.jsx("tbody",{children:u.map(o=>r.jsxs(n.tr,{children:[r.jsx(n.td,{className:"tokens-name",children:o.name}),r.jsx(n.td,{className:"tokens-value",children:o.value}),r.jsx(n.td,{children:r.jsx(n.span,{className:"tokens-preview",children:o.name.includes("color")||o.name.endsWith("-bg")||o.name.endsWith("-border")?r.jsx(n.span,{className:"tokens-preview-color",style:{background:`var(${o.name})`}}):r.jsx(n.span,{className:"tokens-preview-font",children:"Ag"})})})]},o.name))})]})}),`
`,r.jsx(n.h2,{id:"theme-comparison",children:"Theme Comparison"}),`
`,r.jsx("div",{className:"tokens-table-wrap",children:r.jsxs("table",{className:"tokens-table",children:[r.jsx("thead",{children:r.jsxs("tr",{children:[r.jsx("th",{children:"Token"}),r.jsx("th",{children:"Light"}),r.jsx("th",{children:"Dark"})]})}),r.jsx("tbody",{children:D.map(o=>r.jsxs(n.tr,{children:[r.jsx(n.td,{className:"tokens-name",children:o.name}),r.jsx(n.td,{className:"tokens-value",children:o.light}),r.jsx(n.td,{className:"tokens-value",children:o.dark})]},o.name))})]})})]})}function _(a={}){const{wrapper:n}={...h(),...a.components};return n?r.jsx(n,{...a,children:r.jsx(f,{...a})}):f(a)}export{_ as default};
