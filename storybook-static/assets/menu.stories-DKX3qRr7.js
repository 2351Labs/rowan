import"./menu-BeQncxAY.js";import"./menu-item-VM2tMVAx.js";import{c}from"./event-script-39NhYcVW.js";import"./define-CsW7nJMD.js";import"./events-CaQanPdG.js";const v={title:"Components/Menu",tags:["autodocs"]},e={parameters:c({steps:["Click any menu item."],events:["rowan-change"]}),render:()=>{const n=document.createElement("rowan-menu"),s=["Edit","Duplicate","Archive"];for(const r of s){const t=document.createElement("rowan-menu-item");t.value=r.toLowerCase(),t.textContent=r,n.append(t)}return n}};var a,o,m;e.parameters={...e.parameters,docs:{...(a=e.parameters)==null?void 0:a.docs,source:{originalSource:`{
