import"./icon-button-pEZE8bex.js";import{c as g}from"./event-script-39NhYcVW.js";import"./define-BZx74wjy.js";import"./events-CaQanPdG.js";import"./form-BsCuqVMT.js";function a(t,r,{variant:n="ghost",size:o="md",disabled:c=!1}={}){const e=document.createElement("rowan-icon-button");return e.label=t,e.textContent=r,n!=="ghost"&&(e.variant=n),o!=="md"&&(e.size=o),e.disabled=c,e}function v(){const t=document.createElement("div");return t.style.alignItems="center",t.style.display="flex",t.style.flexWrap="wrap",t.style.gap="0.75rem",t}const x={title:"Components/Actions & Feedback/Icon Button",tags:["autodocs"],argTypes:{label:{control:"text"},variant:{control:"select",options:["primary","secondary","ghost","danger"]},size:{control:"select",options:["sm","md","lg"]},disabled:{control:"boolean"},icon:{control:"text"}},args:{label:"Edit",variant:"ghost",size:"md",disabled:!1,icon:"✎"}},s={parameters:g({steps:["Click the icon button.","Toggle Disabled and click again."],events:["rowan-click"]}),render:({label:t,variant:r,size:n,disabled:o,icon:c})=>{const e=document.createElement("rowan-icon-button");return e.label=t,r!=="ghost"&&e.setAttribute("variant",r),n!=="md"&&e.setAttribute("size",n),o&&e.setAttribute("disabled",""),e.textContent=c,e}},i={render:()=>{const t=v();return t.append(a("Edit","✎"),a("Add","+",{variant:"primary"}),a("Open settings","⚙",{variant:"secondary"}),a("Delete","×",{variant:"danger"}),a("Unavailable","⋯",{disabled:!0})),t}};var l,d,u;s.parameters={...s.parameters,docs:{...(l=s.parameters)==null?void 0:l.docs,source:{originalSource:`{
...
}`,...(b=(p=i.parameters)==null?void 0:p.docs)==null?void 0:b.source}}};const A=["Playground","VisualStates"];export{s as Playground,i as VisualStates,A as __namedExportsOrder,x as default};
