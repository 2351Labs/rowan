import{j as r,b as P}from"./index-DFSMdKBE.js";import{useMDXComponents as u}from"./index-BEVLwB8D.js";import"./iframe-B05YVXeY.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-C__6K5js.js";import"./index-Bhqu_tAV.js";const S=`:root,
:host {
  /* Primitive layer */
...
`,x=/^\s*(--rowan-[\w-]+)\s*:\s*([^;]+);/;function j(o){return o.trim().replace(/\s+/g," ")}function V(o){const n={primitive:[],semantic:[],component:[]};let a=null;for(const e of o.split(`
`)){const s=e.trim();if(s.startsWith("/*")){s.includes("Primitive layer")?a="primitive":s.includes("Semantic layer")?a="semantic":s.includes("Component layer")&&(a="component");continue}const l=e.match(x);if(!l||!a)continue;const[,z,T]=l;n[a].push({name:z,value:j(T)})}return n}function k(o){const n=new Map;for(const a of o.split(`
`)){const e=a.match(x);if(!e)continue;const[,s,l]=e;n.set(s,j(l))}return n}function t(o,n){return o.name.localeCompare(n.name,void 0,{numeric:!0})}function i(o,n){return o.filter(a=>a.name.startsWith(n))}function R(o,n){return o.filter(a=>n.some(e=>a.name.startsWith(e)))}const d=V(S),y=k(M),N=k(C),c=[...d.primitive],w=i(c,"--rowan-color-").sort(t),m=i(c,"--rowan-space-").sort(t),b=i(c,"--rowan-radius-").sort(t),p=R(c,["--rowan-font-","--rowan-line-height"]).sort(t),v=i(c,"--rowan-border-").sort(t),g=[...d.semantic].sort(t),f=[...d.component].sort(t),A=[...new Set([...y.keys(),...N.keys()])].sort((o,n)=>o.localeCompare(n,void 0,{numeric:!0})),D=A.map(o=>({name:o,light:y.get(o)||"-",dark:N.get(o)||"-"})),L=["src/tokens/tokens.css","src/tokens/themes/light.css","src/tokens/themes/dark.css"];function h(o){const n={h1:"h1",h2:"h2",p:"p",span:"span",td:"td",tr:"tr",...u(),...o.components};return r.jsxs(r.Fragment,{children:[r.jsx(P,{title:"Foundations/Tokens"}),`
...
and component tokens bind component defaults to semantic meaning.`})}),r.jsxs("div",{className:"tokens-layer-grid",children:[r.jsxs("article",{className:"tokens-layer-card",children:[r.jsx("h3",{children:"Primitive layer"}),r.jsx("p",{children:"Raw design values: palette ramps, spacing, radius, typography, and structural constants."}),r.jsxs("span",{className:"tokens-layer-count",children:[w.length+m.length+b.length+p.length+v.length," tokens"]})]}),r.jsxs("article",{className:"tokens-layer-card",children:[r.jsx("h3",{children:"Semantic layer"}),r.jsx("p",{children:"Theme-level meaning used by components: background, foreground, accent, border, danger."}),r.jsxs("span",{className:"tokens-layer-count",children:[g.length," tokens"]})]}),r.jsxs("article",{className:"tokens-layer-card",children:[r.jsx("h3",{children:"Component layer"}),r.jsx("p",{children:"Default component hooks that map to semantic values and support local overrides."}),r.jsxs("span",{className:"tokens-layer-count",children:[f.length," tokens"]})]})]}),r.jsxs("p",{className:"tokens-note",children:[r.jsx(n.p,{children:"Source of truth:"})," ",L.join(", ")]}),r.jsx("p",{className:"tokens-theme-hint",children:r.jsx(n.p,{children:"Use the Storybook toolbar Theme toggle to inspect token behavior across light and dark modes."})})]}),`
`,r.jsx(n.h2,{id:"primitive-color",children:"Primitive: Color"}),`
`,r.jsx("div",{className:"tokens-table-wrap",children:r.jsxs("table",{className:"tokens-table",children:[r.jsx("thead",{children:r.jsxs("tr",{children:[r.jsx("th",{children:"Token"}),r.jsx("th",{children:"Value"}),r.jsx("th",{children:"Preview"})]})}),r.jsx("tbody",{children:w.map(a=>r.jsxs(n.tr,{children:[r.jsx(n.td,{className:"tokens-name",children:a.name}),r.jsx(n.td,{className:"tokens-value",children:a.value}),r.jsx(n.td,{children:r.jsx(n.span,{className:"tokens-preview",children:r.jsx(n.span,{className:"tokens-preview-color",style:{background:`var(${a.name})`}})})})]},a.name))})]})}),`
