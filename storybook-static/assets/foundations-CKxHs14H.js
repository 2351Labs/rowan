import{j as r,b as P}from"./index-BgKef1Jd.js";import{useMDXComponents as u}from"./index-8AR26AMK.js";import"./iframe-DMPN-3Hw.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-C__6K5js.js";import"./index-Bhqu_tAV.js";const S=`:root,
:host {
  /* Primitive layer */
...
`)){const e=a.match(x);if(!e)continue;const[,s,l]=e;n.set(s,k(l))}return n}function t(o,n){return o.name.localeCompare(n.name,void 0,{numeric:!0})}function i(o,n){return o.filter(a=>a.name.startsWith(n))}function R(o,n){return o.filter(a=>n.some(e=>a.name.startsWith(e)))}const d=V(S),y=j(M),z=j(C),c=[...d.primitive],w=i(c,"--rowan-color-").sort(t),m=i(c,"--rowan-space-").sort(t),b=i(c,"--rowan-radius-").sort(t),f=R(c,["--rowan-font-","--rowan-line-height"]).sort(t),g=i(c,"--rowan-border-").sort(t),v=[...d.semantic].sort(t),p=[...d.component].sort(t),A=[...new Set([...y.keys(),...z.keys()])].sort((o,n)=>o.localeCompare(n,void 0,{numeric:!0})),D=A.map(o=>({name:o,light:y.get(o)||"-",dark:z.get(o)||"-"})),L=["src/tokens/tokens.css","src/tokens/themes/light.css","src/tokens/themes/dark.css"];function h(o){const n={h1:"h1",h2:"h2",p:"p",span:"span",td:"td",tr:"tr",...u(),...o.components};return r.jsxs(r.Fragment,{children:[r.jsx(P,{title:"Foundations/Tokens"}),`
...
`,r.jsx("div",{className:"tokens-table-wrap",children:r.jsxs("table",{className:"tokens-table",children:[r.jsx("thead",{children:r.jsxs("tr",{children:[r.jsx("th",{children:"Token"}),r.jsx("th",{children:"Value"}),r.jsx("th",{children:"Preview"})]})}),r.jsx("tbody",{children:[...f,...g].map(a=>r.jsxs(n.tr,{children:[r.jsx(n.td,{className:"tokens-name",children:a.name}),r.jsx(n.td,{className:"tokens-value",children:a.value}),r.jsx(n.td,{children:r.jsx(n.span,{className:"tokens-preview",children:r.jsx(n.span,{className:"tokens-preview-font",children:"Ag"})})})]},a.name))})]})}),`
