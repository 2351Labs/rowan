import{j as r,b as P}from"./index-RHBU38dS.js";import{useMDXComponents as h}from"./index-CP7eXVT7.js";import"./iframe-iWAoYN3I.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-C__6K5js.js";import"./index-Bhqu_tAV.js";const S=`:root,
:host {
  /* Primitive layer */
...
`)){const s=e.trim();if(s.startsWith("/*")){s.includes("Primitive layer")?a="primitive":s.includes("Semantic layer")?a="semantic":s.includes("Component layer")&&(a="component");continue}const i=e.match(x);if(!i||!a)continue;const[,N,T]=i;n[a].push({name:N,value:k(T)})}return n}function j(o){const n=new Map;for(const a of o.split(`
`)){const e=a.match(x);if(!e)continue;const[,s,i]=e;n.set(s,k(i))}return n}function t(o,n){return o.name.localeCompare(n.name,void 0,{numeric:!0})}function l(o,n){return o.filter(a=>a.name.startsWith(n))}function R(o,n){return o.filter(a=>n.some(e=>a.name.startsWith(e)))}const w=V(S),y=j(M),z=j(C),c=[...w.primitive],d=l(c,"--rowan-color-").sort(t),m=l(c,"--rowan-space-").sort(t),b=l(c,"--rowan-radius-").sort(t),g=R(c,["--rowan-font-","--rowan-line-height"]).sort(t),v=l(c,"--rowan-border-").sort(t),p=[...w.semantic].sort(t),f=[...w.component].sort(t),A=[...new Set([...y.keys(),...z.keys()])].sort((o,n)=>o.localeCompare(n,void 0,{numeric:!0})),D=A.map(o=>({name:o,light:y.get(o)||"-",dark:z.get(o)||"-"})),L=["src/tokens/tokens.css","src/tokens/themes/light.css","src/tokens/themes/dark.css"];function u(o){const n={h1:"h1",h2:"h2",p:"p",span:"span",td:"td",tr:"tr",...h(),...o.components};return r.jsxs(r.Fragment,{children:[r.jsx(P,{title:"Foundations/Tokens"}),`
