var _=Object.defineProperty;var E=o=>{throw TypeError(o)};var $=(o,a,r)=>a in o?_(o,a,{enumerable:!0,configurable:!0,writable:!0,value:r}):o[a]=r;var m=(o,a,r)=>$(o,typeof a!="symbol"?a+"":a,r),P=(o,a,r)=>a.has(o)||E("Cannot "+r);var e=(o,a,r)=>(P(o,a,"read from private field"),r?r.call(o):a.get(o)),c=(o,a,r)=>a.has(o)?E("Cannot add the same private member more than once"):a instanceof WeakSet?a.add(o):a.set(o,r),l=(o,a,r,n)=>(P(o,a,"write to private field"),n?n.call(o,r):a.set(o,r),r),w=(o,a,r)=>(P(o,a,"access private method"),r);function B(o,a){return o.hasAttribute(a)}function rr(o,a,r){if(r){o.setAttribute(a,"");return}o.removeAttribute(a)}function or(o,a,r=""){return o.getAttribute(a)??r}function ar(o,a,r){if(r==null||r===""){o.removeAttribute(a);return}o.setAttribute(a,String(r))}function nr(o,a,r=0){const n=o.getAttribute(a);if(n==null)return r;const i=Number(n);return Number.isFinite(i)?i:r}function er(o,a,r){if(r==null||!Number.isFinite(r)){o.removeAttribute(a);return}o.setAttribute(a,String(r))}const F=`
:root,
:host {
  /* Primitive layer */
