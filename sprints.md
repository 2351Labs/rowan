...
**Status:** `@rowan-ui/core@0.6.2` is on npm. Git is `0.7.0` (dashboard hosts Stable, public `useRowanElement` removed). Publish `0.7.0` after this lands on `main`.
...
- Vue/Svelte wrappers.
- Data/dashboard track: `sprints-data.md` (Sprints 1–11 done; KPI, sparkline, bar, and donut are Stable; area, stacked bar, and image are experimental).
