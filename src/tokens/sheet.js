...
export const unregisteredTokenNames = [
  ...
  "--rowan-skeleton-shimmer-duration",
  ...
  "--rowan-split-pane-gap",
  "--rowan-split-pane-separator-size",
  "--rowan-split-pane-separator-color",
  "--rowan-split-pane-separator-active-color",
  "--rowan-split-pane-focus-ring",
  "--rowan-split-pane-disabled-opacity",
  "--rowan-app-layout-bg",
  "--rowan-app-layout-fg",
  "--rowan-app-layout-header-bg",
  "--rowan-app-layout-header-border",
  "--rowan-app-layout-navigation-bg",
  "--rowan-app-layout-navigation-border",
  "--rowan-app-layout-navigation-width",
  "--rowan-app-layout-content-padding",
  "--rowan-app-layout-focus-ring",
  "--rowan-app-layout-backdrop",
  "--rowan-app-layout-min-block-size",
  "--rowan-app-layout-header-min-block-size",
  "--rowan-app-layout-header-padding",
  "--rowan-app-layout-navigation-padding",
  "--rowan-app-layout-mobile-navigation-width",
  "--rowan-app-layout-mobile-content-padding",
  "--rowan-side-nav-gap",
  "--rowan-side-nav-item-fg",
  "--rowan-side-nav-item-muted-fg",
  "--rowan-side-nav-item-hover-bg",
  "--rowan-side-nav-item-active-bg",
  "--rowan-side-nav-item-active-fg",
  "--rowan-side-nav-item-focus-ring",
  "--rowan-side-nav-item-radius",
  "--rowan-side-nav-item-font-family",
  "--rowan-side-nav-item-font-size",
...
export const componentTokenDeclarations = [
  ...
  [
    "--rowan-button-ghost-hover-bg",
    "color-mix(in srgb, var(--rowan-color-accent) 9%, transparent)",
  ],
  [
    "--rowan-button-ghost-active-bg",
    "color-mix(in srgb, var(--rowan-color-accent) 16%, transparent)",
  ],
  ["--rowan-button-ghost-shadow", "0 0 0 transparent"],
  ["--rowan-button-danger-bg", "var(--rowan-color-danger)"],
  ["--rowan-button-danger-fg", "var(--rowan-button-fg)"],
  ...
  [
    "--rowan-button-danger-shadow",
    "inset 0 1px 0 rgb(255 255 255 / 12%), 0 1px 1px rgb(90 29 23 / 18%)",
  ],
  ["--rowan-button-sm-font-size", "0.8125rem"],
  ["--rowan-button-sm-min-block-size", "2.25rem"],
  ["--rowan-button-sm-padding-inline", "var(--rowan-space-3)"],
  ...
  [
    "--rowan-side-nav-item-active-bg",
    "color-mix(in srgb, var(--rowan-color-accent) 15%, transparent)",
  ],
  ["--rowan-side-nav-item-active-fg", "var(--rowan-color-fg)"],
  ["--rowan-side-nav-item-focus-ring", "var(--rowan-focus-ring)"],
  ["--rowan-side-nav-item-radius", "var(--rowan-radius-sm)"],
  ...
  [
    "--rowan-tree-item-selected-bg",
    "color-mix(in srgb, var(--rowan-color-accent) 14%, transparent)",
  ],
  ["--rowan-tree-item-selected-fg", "var(--rowan-color-fg)"],
  ["--rowan-tree-item-children-border", "var(--rowan-color-border)"],
  ["--rowan-tree-item-focus-ring", "var(--rowan-focus-ring)"],
