...
export class RowanCheckbox extends BaseElement {
  ...
  static styleUrl = new URL("./checkbox.css", import.meta.url).href;
  ...
  get indeterminate() {
    return this.readBoolean("indeterminate");
  }

  set indeterminate(value) {
    this.reflectBoolean("indeterminate", Boolean(value));
  }
  ...
  #applyDefaultA11y() {
    ...
    const checkedState = this.indeterminate ? "mixed" : this.checked ? "true" : "false";
    ...
    if (!this.hasAttribute("aria-checked") && "ariaChecked" in this.internals) {
      this.internals.ariaChecked = checkedState;
    }
...
define("rowan-checkbox", RowanCheckbox);
