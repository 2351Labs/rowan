...
import { RowanBulletChart, type RowanBulletChartRange } from "@rowan-ui/core/bullet-chart";
...
import { RowanDataState } from "@rowan-ui/core/data-state";
...
const bulletRange: RowanBulletChartRange = { from: 0, to: 60, label: "Poor", tone: "danger" };
bulletChart.ranges = [bulletRange];
bulletChart.value = 82;
bulletChart.target = 90;
...
const dataState: RowanDataState = document.createElement("rowan-data-state");
...
const gaugeChart: RowanGaugeChart = document.createElement("rowan-gauge-chart");
const gaugeRange: RowanGaugeChartRange = { from: 0, to: 50, label: "Low", tone: "danger" };
gaugeChart.min = 0;
gaugeChart.max = 100;
gaugeChart.value = 72;
gaugeChart.target = 80;
gaugeChart.ranges = [gaugeRange];
const iconButton: RowanIconButton = document.createElement("rowan-icon-button");
const image: RowanImage = document.createElement("rowan-image");
image.src = "/stills/north-yard.jpg";
image.alt = "North yard camera";
