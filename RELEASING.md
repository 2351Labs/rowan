...
Version in `package.json` is `0.11.0` for core, icons, and MapLibre. Do **not**
call this `1.0`. Experimental source-meta, data-state, area, stacked-bar,
bullet, gauge, and image may still change. Publish is a separate step after
this catalog commit is on `main`: tag `v0.11.0`.

## 0.12.0 cut

Version in `package.json` is `0.12.0` for core, icons, and MapLibre. Do **not**
call this `1.0`. Experimental source-meta, data-state, area, stacked-bar,
bullet, gauge, and image may still change. Publish is a separate step after
...
Version in `package.json` is `0.14.0` for core, icons, and MapLibre. Do **not**
call this `1.0`. Experimental `rowan-combo-chart` may still change. Publish is
a separate step after this catalog commit is on `main`: tag `v0.14.0`.

## 0.14.1 cut

Version in `package.json` is `0.14.1` for core, icons, and MapLibre. Do **not**
